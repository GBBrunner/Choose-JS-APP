...
function movieCarousel(initialUrl) {
  ...
  let popularList = [], list = [], currentIndex = 0, animating = false, debounceTimer = null;
  ...
  if (!query) { list = [...popularList]; currentIndex = 0; return render(); }
    try {
